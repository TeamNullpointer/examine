...
public class Admin_stupdate_checkStartAction  extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		riyu = (String)req.getParameter("riyu");
		...
		System.out.println("チェックの値："+riyu);
		if(riyu.equals("1") && password.equals(password2) ){
			System.out.println("パスの変更、パスワード確認用と入力された値が一致");
			//パスワードが正しいORパスワードを変更しない
			rd = req.getRequestDispatcher("src/view/jsp/admin/st/admin_stupdate_check.jsp");
	// TODO 自動生成されたメソッド・スタブ
	rd.forward(req, resp);
		}
		if( riyu.equals("2") && password.equals("") && password2.equals("")){
